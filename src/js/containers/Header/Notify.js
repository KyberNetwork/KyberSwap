...
export default class Notify extends React.Component {
    ...
    render() {
        ...
        const transactions = Object.keys(this.props.txs).map((hash) => {
            ...
            var tx = this.props.txs[hash]
            return (
                <li key={hash}>
                    <a class={classTx} href={this.hashDetailLink(tx.hash)} target="_blank">
                        <div class="title"><span class="amount">{this.createRecap(tx.type, tx.data)}</span></div>
