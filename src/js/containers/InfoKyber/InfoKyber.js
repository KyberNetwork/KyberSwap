        ...
        <div class="row">
          <div class="column small-11 medium-9 large-8 small-centered">
            ...
            <p class="info">Version: 0.0.1<br/>Chain: Kovan
              <label>Node endpoint
                <input class="address" type="text" value="https://kovan.infura.io/0BRKxQ0SFvAxGL72cbXi" readOnly="true" />
              </label>
              <label>Reserve contract address
                <input class="address" type="text" value="0x60860ce9688f4200e87e61b9a9a171cee1dc5f65"  readOnly="true"/>
              </label>
              <label>Network contract address
                <input class="address" type="text" value="0x11542d7807dfb2b44937f756b9092c76e814f8ed"  readOnly="true"/>
