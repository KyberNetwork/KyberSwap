  ...
  render() {
    ...
    return (
      <div className="exchange-terms" onClick={() => {this.props.analytics.callTrack("acceptTerm", this.props.tradeType)}}>
        <span>
          {this.props.tradeType === "swap" ? this.props.translate("terms.description_term_swap") || "By Swapping, you agree to the"
          : this.props.translate("terms.description_term_transfer") || "By Transfering, you agree to the"}
        </span>
