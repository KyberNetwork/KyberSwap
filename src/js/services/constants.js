...
const HISTORY_BLOCK_RANGE = 50000

export default {
  ERC20, KYBER_NETWORK, CONNECTIONS_MODE, EPSILON, ETHER_ADDRESS, ETH, RESERVES, KYBER_WALLET,
  KYBER_WALLET_DATA, INIT_EXCHANGE_FORM_STATE, INIT_TRANSFER_FORM_STATE,
  RATE_EPSILON, TRADE_TOPIC, KOVAN_ETH_URL, IDLE_TIME_OUT, NODE_ENDPOINT, HISTORY_BLOCK_RANGE
}
