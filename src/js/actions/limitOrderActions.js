...
export function fetchFeeComplete(fee, feeAfterDiscount, discountPercentage, transferFee, signFee, err = null) {
  return {
    type: "LIMIT_ORDER.FETCH_FEE_COMPLETE",
    payload: { fee, feeAfterDiscount, discountPercentage, transferFee, signFee, err }
  }
}
