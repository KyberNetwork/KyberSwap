...
export function importNewAccount(address, type, keystring, ethereum, tokens, metamask = null, walletType = "kyber") {
  return {
    type: "ACCOUNT.IMPORT_NEW_ACCOUNT_PENDING",
    payload: { address, type, keystring, ethereum, tokens, metamask, walletType }
  }
}
...
export function importAccountMetamask(web3Service, networkId, ethereum, tokens, translate, walletType) {
  return {
