...
const ExchangeBodyLayout = (props) => {
  ...
  return (
    <div className={"exchange__form theme__background-2"}>
      {(props.sourceTokenSymbol === "BAND" || props.destTokenSymbol === "BAND") && (
        <div className="common__text-center">
          <p className="common__notification theme__border-3 theme__background-11">Win BAND tokens by participating in our trading contest (till 21 April). Please login to participate. Click <a href={"/promo/band?utm_source=band-infobox&utm_medium=notibar&utm_campaign=band-contest"} target="_blank">here</a> for more details</p>
        </div>
      )}
      <div>
