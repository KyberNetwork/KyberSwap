...
const ExchangeBodyLayout = (props) => {
  ...
  return (
    <div className={"exchange__form theme__background-2"}>
      {(props.sourceTokenSymbol == "RLC" || props.destTokenSymbol == "RLC") && <p className={"text-center"}>Trade and win RLC tokens in our trading contest (ends 22 Dec)! Sign In to your KyberSwap account AND Connect your wallet to participate! Click <a className="exchange-terms__link" href={"/promo/rlc?utm_source=rlc-page&utm_medium=informative&utm_campaign=rlc-contest"} target="_blank">here</a> for more details</p>}
      <div>
