        ...
        <div className="balance-panel">
          <div id="search-balance" className="row">
            <div className="column small-10">
              <input type="text" placeholder={props.translate("address.search") || "Search"} onChange={(e) => props.changeSearchBalance(e)} value = {props.searchWord} onClick={ (e) => props.clickOnInput() } className="search-input"/>
            </div>
