  ...
  var render = (
    <div id="transfer-screen">
      <div className="grid-x">
        <div className={"cell medium-6 large-3 balance-wrapper-normal " + (props.isOpenLeft ? "balance-wrapper-opened" : "balance-wrapper-closed") + (props.isOpenLeft && props.haveAnimationLeft ? " balance-wrapper" : "") + (anyErrors(props.errors) ? " error" : "")} id="balance-account-wrapper">
          {/* <AccountBalance
        ...
        <div class={"cell medium-6 large-9 swap-wrapper swap-wrapper--transfer" + getStatusClasses("swap-wrapper")}>
          ...
          <div className="transfer-detail grid-x exchange-col">
            ...
            <div className={"cell small-12 large-4 transfer-col transfer-advanced large-offset-0 " + (props.isOpenRight && props.haveAnimationRight ? "advance-layout" : "advance-layout-closed") }>
              {props.isOpenRight && (
