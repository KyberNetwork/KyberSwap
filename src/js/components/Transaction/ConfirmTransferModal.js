...
const ConfirmTransferModal = (props) => {
  return (
    <div>
      <div className="title text-center">{props.type} Confirm</div>
      ...
      <div className="overlap">
        <a className={"button accent process-submit " + (props.isConfirming ? "waiting" : "")} onClick={(e) => props.onExchange(e)}>Confirm</a>
      </div>
    </div>
