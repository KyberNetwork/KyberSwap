      ...
      return (
        <div className={"address-item"} key={address.addressString}>
          ...
          <div class="address-item__import">
            <div class="balance theme__text-6" title={address.balance}>
              {address.balance == '-1' ?
                <img
                  src={require(`../../../assets/img/${props.theme === 'dark' ? 'waiting-black' : 'waiting-white'}.svg`)}/>
    ...
    return (
      <div className={"import-modal"}>
        ...
        <div className={"import-modal__footer import-modal__footer--cold-wallet theme__background-2"}>
          <div class={'address-button address-button-previous ' + (props.isFirstList ? 'disabled' : '')}
